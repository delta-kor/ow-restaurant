...
import NewThirdRecipeJson from '@/store/recipe-new-third.json'
...
const newThirdRecipe = Recipe.create(NewThirdRecipeJson).pipe(Effect.runSync)
...
export function getRecipe(id: string | null) {
  ...
  if (id === 'new-third') return newThirdRecipe
